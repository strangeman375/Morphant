...
> **Статус: устарел и неактуален.** Этот документ относится к прежнему
> `Template()`-дизайну и сохранён только для истории. Текущий roadmap находится
> в [`MAPPING_API_IMPLEMENTATION_PLAN.md`](MAPPING_API_IMPLEMENTATION_PLAN.md).
