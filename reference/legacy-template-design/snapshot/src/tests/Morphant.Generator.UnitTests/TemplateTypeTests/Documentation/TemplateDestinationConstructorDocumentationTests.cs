...
"""
    ...
    internal sealed class DestinationMorphantTemplateConstructorParameters
    {
        ...
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<string> @event = null!;
    }
""";
...
"""
        ...
        public DestinationMorphantTemplate(
            ...
            global::Morphant.Members.ConstructorParameter<string> @event)
        {
        }
""";
...
"""
    ...
    internal sealed class DestinationMorphantTemplateConstructorParameters
    {
        ...
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<global::TestCase.Status> status = null!;

        /// <summary>
        /// Configures the <c>fallback</c> constructor argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<global::TestCase.Status> fallback = null!;
    }
""";
...
"""
        ...
        public DestinationMorphantTemplate(
            global::Morphant.Members.ConstructorParameter<global::TestCase.Status> status = null!,
            global::Morphant.Members.ConstructorParameter<global::TestCase.Status> fallback = null!)
        {
        }
""";
...
"""
    ...
    internal sealed class DestinationMorphantTemplateConstructorParameters
    {
        ...
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<int[]> values = null!;
    }
""";
...
"""
        ...
        public DestinationMorphantTemplate(global::Morphant.Members.ConstructorParameter<int[]> values = null!)
        {
        }
""";
