...
{
    [Test]
    public async Task Preserves_source_warning_after_construct_using_suppression()
    {
        // lang=c#
        const string source =
"""
...
#pragma warning disable CS0618
                .ConstructUsing(source => new Destination(source.Value))
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        #pragma warning disable CS0618
        private global::TestCase.Destination __ConstructUsing(global::TestCase.Source source) => new global::TestCase.Destination(source.Value);
        #pragma warning restore CS0618
    }
}
""";
