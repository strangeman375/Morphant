...
{
    [Test]
    public async Task ConvertMultiline()
    {
        const string source =
// lang=c#
"""
...
namespace TestCase
{
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>().Convert(source => {
#warning {|CS1030:source reminder|}
var {|CS0219:unused|} = 1; return {|CS0618:new Destination($@"first
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __ConvertDestination(global::TestCase.Source? source)
        {
