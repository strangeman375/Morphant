...
{
    [Test]
    public async Task ResolveUsingTypes()
    {
        const string source =
// lang=c#
"""
...
#pragma warning disable CS0618
            builder.Map<Source, Destination>().ResolveUsing((source, previous) => previous.HasValue ? previous.Value : new Destination());
...
namespace TestCase
{
    ...
    #pragma warning restore CS0618
    {
        ...
        #pragma warning disable CS0618
        private global::TestCase.Destination __ResolveUsing(global::Morphant.Option<global::TestCase.Destination> previous) => previous.HasValue ? previous.Value : new global::TestCase.Destination();
        #pragma warning restore CS0618
    }
}
""";
