...
{
    // lang=c#
    private const string SiblingQueriesSource =
"""
#nullable enable
...
""";
    ...
    // lang=c#
    private const string SiblingQueriesMapper =
"""
// <auto-generated />
#nullable enable
        ...
        global::Morphant.ITypeMapper<global::QueryNames.Source, global::QueryNames.Destination>
    {
            ...
            global::QueryNames.Source source)
        {
            return new global::QueryNames.Destination(
                value: string.Join(",", from value in source.Values select value) + "/" + string.Join(",", from value in source.Values select value + 1));
        }
