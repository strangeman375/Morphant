...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.TestMapper.Destination>
    {
        ...
        protected override bool Supports(
            ...
            global::System.Type destinationType) =>
                (sourceType == typeof(global::TestCase.Source) &&
                    destinationType == typeof(global::TestCase.TestMapper.Destination)) ||
                base.Supports(sourceType, destinationType);
...
""";
    ...
    [Test]
    public async Task Matches_constructor_arguments_by_exact_then_unique_case_insensitive_name()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    public sealed class Destination
    {
        public Destination(int id, string title, int code = 73)
        {
            Id = id;
            Title = title;
            Code = code;
