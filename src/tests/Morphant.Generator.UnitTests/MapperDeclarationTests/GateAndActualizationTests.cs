...
""";
    ...
    [Test]
    public void Making_a_containing_type_accessible_removes_MORPH0059()
    {
        // lang=c#
        const string invalidSource =
"""
...
""";
    ...
    [Test]
    public void Suppressing_MORPH0059_does_not_restore_generation()
    {
        // lang=c#
        const string source =
"""
...
""";
        ...
        var result = MapperDeclarationGeneratorTest.Run(
            ...
            new Dictionary<string, ReportDiagnostic>
            {
                ["MORPH0059"] = ReportDiagnostic.Suppress
            });
