...
{
    // lang=c#
    private const string CollectionOutArgumentSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionOutArgument9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        #line 100 "CollectionCalls.cs"
            static string Join(string left, int right, string name) => left + ":" + right + ":" + name;
            return Join(CreateBoxedBag(out var value).Value, value = 5, "value");

            global::ExtensionCases.BoxedBag CreateBoxedBag(out int value)
            {
                var boxedBag = new global::ExtensionCases.BoxedBag();
                boxedBag.Add<int>(int.TryParse("4", out value) ? value : source, member: (object?)"Configure");
                return boxedBag;
            }
        #line default
        }
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionOutArgument10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
