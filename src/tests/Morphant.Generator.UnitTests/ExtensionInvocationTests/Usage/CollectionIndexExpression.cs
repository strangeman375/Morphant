...
{
    // lang=c#
    private const string CollectionIndexExpressionSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionIndexExpression9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        {
            var indexed = new global::ExtensionCases.Indexed();
            int index = global::ExtensionCases.Mapper.Next();
            indexed[index].Add<int>(source, member: (object?)"Configure");
            indexed[index].Add<int>(source + 1, member: (object?)"Configure");
            return indexed.Bag.Value;
        }
    }
}
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionIndexExpression10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
