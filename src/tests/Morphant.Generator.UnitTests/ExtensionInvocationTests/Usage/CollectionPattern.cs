...
{
    // lang=c#
    private const string CollectionPatternSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionPattern9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        {
        #line 100 "CollectionCalls.cs"
            var first = source switch { > 0 and var value => CreateBoxedBag(value).Value, _ => "skip" };
        #line default
            return first;
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionPattern10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
