...
{
    // lang=c#
    private const string CollectionTypedLocalSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionTypedLocal9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        #line 100 "CollectionCalls.cs"
            ...
            global::System.Collections.IEnumerable bag = boxedBag;
            return ((global::ExtensionCases.BoxedBag)bag).Value;
        #line default
        }
    }
}
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionTypedLocal10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
