...
{
    // lang=c#
    private const string CollectionRefLikeSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionRefLike9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        {
        #line 100 "CollectionCalls.cs"
            global::System.Span<int> buffer = stackalloc int[] { source };
            return source > 0 ? CreateBoxedBag(buffer).Value : "skip";

            global::ExtensionCases.BoxedBag CreateBoxedBag(global::System.Span<int> buffer)
            {
                var boxedBag = new global::ExtensionCases.BoxedBag();
                boxedBag.Add<int>(buffer[0], member: (object?)"Configure");
                return boxedBag;
            }
        #line default
        }
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionRefLike10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
