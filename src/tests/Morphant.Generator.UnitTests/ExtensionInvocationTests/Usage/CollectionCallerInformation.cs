...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionCallerInformation9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        #line 100 "CollectionCalls.cs"
            ...
            {
                { source.Twice(), 7, "Configure", "CollectionCalls.cs", 100, "source.Twice()" },
                { (source + 1).Twice(), 9, "Configure", "CollectionCalls.cs", 100, "(source + 1).Twice()" }
            };
        #line 110 "CollectionCalls.cs"
            var extended = new global::ExtensionCases.ExtendedBag
            {
                { source.Twice(), "Configure", 110, "source.Twice()" }
            };
        #line 120 "CollectionCalls.cs"
            var boxed = new global::ExtensionCases.BoxedBag();
            boxed.Add<int>(source, member: (object?)"Configure");
        #line default
            return string.Join("|", bag.Values) + "|" + extended.Value + "|" + boxed.Value;
        }
    }
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionCallerInformation10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
