...
{
    // lang=c#
    private const string CollectionQuerySource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionQuery9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        {
        #line 100 "CollectionCalls.cs"
            var first = string.Join("|", from value in new[] { source, source + 1 } select CreateBoxedBag(value).Value);
        #line default
            return first;

            global::ExtensionCases.BoxedBag CreateBoxedBag(int value)
            {
                var boxedBag = new global::ExtensionCases.BoxedBag();
                boxedBag.Add<int>(value, member: (object?)"Configure");
                return boxedBag;
            }
        }
    }
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionQuery10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
