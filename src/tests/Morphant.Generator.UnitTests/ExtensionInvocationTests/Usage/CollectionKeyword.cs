...
{
    // lang=c#
    private const string CollectionKeywordSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] CollectionKeyword9Sources =
    [
...
namespace ExtensionCases
{
        ...
        global::Morphant.ITypeMapper<int, string>
    {
        ...
        {
        #line 100 "CollectionCalls.cs"
            var @event = new global::ExtensionCases.Event();
            @event.Add<int>(source, member: (object?)"Configure");
            return @event.Value;
        #line default
        }
    }
...
"""),
    ...
    private static readonly (string Hint, string Source)[] CollectionKeyword10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.Int32ToString__2f078999b56fc6fe4d4c3aded5d88f40.g.cs",
            // lang=c#
"""
