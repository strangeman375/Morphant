...
{
    // lang=c#
    private const string SourceScopeSource =
"""
#nullable enable
...
""";
    ...
    private static readonly (string Hint, string Source)[] SourceScope9Sources =
    [
...
namespace ExtensionCases.Mappers
{
        ...
        global::Morphant.ITypeMapper<string, int>
    {
        ...
        private int __ConvertDestination(string? source) => global::Imported.Operations.Describe(source!) + source!.Length.Independent();
    }
}
"""),
    ];

    private static readonly (string Hint, string Source)[] SourceScope10Sources =
    [
        ("Morphant.Generated.MappingExtension.Mapper.StringToInt32__68e3eae43b0452f6e902974d4c0eaa7a.g.cs",
            // lang=c#
"""
