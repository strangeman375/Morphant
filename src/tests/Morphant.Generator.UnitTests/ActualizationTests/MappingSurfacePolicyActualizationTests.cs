...
{
    [Test]
    public void Resolves_independent_nullable_and_non_nullable_reference_surfaces_without_warnings()
    {
        // lang=c#
        const string source =
"""
...
""";
    ...
    [Test]
    public void Resolves_independent_nullable_and_non_nullable_SystemTuple_surfaces_without_warnings()
    {
        // lang=c#
        const string source =
"""
...
""";
    ...
    [Test]
    public void Actualizes_family_receivers_across_tuple_edits()
    {
        RunAndAssert(
            LanguageVersion.CSharp9,
            new TestConstructionSurfaceGenerator(),
            Step(
                "System.Tuple pair uses the family receiver",
                SystemTupleSource,
                (SystemTupleHintName, SystemTupleExtension)),
            Step(
            ...
            Step(
                ...
                (ScopedHintName, ScopedExtension)),
            Step(
                "System.Tuple pair restored in the same family",
                SystemTupleSource,
                (SystemTupleHintName, SystemTupleExtension)));
    }
    ...
    private const string ScopedHintName =
        "Morphant.Generated.MappingExtension.CommonMapper.SystemTuple1ToInt32__2d17d4a79fc8c31d58c03ae20e3c0796.g.cs";
...
""";
    ...
    // lang=c#
    private const string SystemTupleExtension =
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<TMapper, global::System.Tuple<int, int>, int> ConstructUsing<TMapper>(
            this global::Morphant.IMappingBuilder<global::TestCase.CommonMapper<TMapper>, global::System.Tuple<int, int>, int> builder,
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<TMapper, global::System.Tuple<(int X, int Y)>, int> ConstructUsing<TMapper>(
            this global::Morphant.IMappingBuilder<global::TestCase.CommonMapper<TMapper>, global::System.Tuple<(int X, int Y)>, int> builder,
