...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, int>
    {
        ...
        private int __ConvertDestination(global::TestCase.Source? source) => ((source!.ReadText() is { } conditionalReceiver ? global::Extensions.TextExtensions.Measure(conditionalReceiver) : default(int?)) ?? default(int? /* keep */)) ??
        (int? )1 ?? 0;
    }
}
""")
