...
[TestFixture]
internal sealed class PreviousAndNegatedTests
{
    [Test]
    public async Task Lowers_known_out_guards_and_negation()
    {
        // lang=c#
        const string source =
"""
...
"""),
            ("Morphant.Generated.MappingExtension.AndMapper.SourceToDestination__c97ed9045b40dd1a55d4934fe2ea0680.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MappingExtension.NegatedMapper.SourceToDestination__4a02d3c1027c431cdea3c9df8d181924.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="construct">Inline lambda returning a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Construct<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Inline lambda returning the existing destination value or a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Resolve<global::TestCase.Source, global::TestCase.Destination, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="construct">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ConstructUsing<global::TestCase.Source, global::TestCase.Destination> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ResolveUsing<global::TestCase.Source, global::TestCase.Destination, global::TestCase.Destination> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="mapping">Lambda, method group, or delegate returning the final result.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/convert.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Convert<global::TestCase.Source?, global::TestCase.Destination> mapping)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.MemberExtension.AndMapper.SourceToDestination__c97ed9045b40dd1a55d4934fe2ea0680.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.AndMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MemberExtension.NegatedMapper.SourceToDestination__4a02d3c1027c431cdea3c9df8d181924.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="members">Inline lambda. Unspecified members follow MemberSelection.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/members.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.NegatedMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Members<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationMembers> members)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.TypeMapper.AndMapper__279af21c0113ed8f4c1b937b3372cbbb.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class AndMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Create(
            global::TestCase.Source source)
        {
            global::TestCase.Destination? current = default;
...
"""),
            ("Morphant.Generated.TypeMapper.NegatedMapper__4f3d9cf2616bd5c8fd963894f1414cc9.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class NegatedMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        /// <inheritdoc/>
        protected override bool Supports(
