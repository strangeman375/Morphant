...
[TestFixture]
internal sealed class CustomOperatorsConstructMembersTests
{
    [Test]
    public async Task Preserves_custom_logical_operators_in_ConstructMembers()
    {
        // lang=c#
        const string source =
"""
...
"""),
            ("Morphant.Generated.MappingExtension.ConstructMembersAfterMapper.SourceToDestination__23392b58600c0478a53aab16ab0fd569.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MappingExtension.ConstructMembersBeforeMapper.SourceToDestination__0bcf691cc3226b74a8cd073c31ed0ffa.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="construct">Inline lambda returning a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Construct<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Inline lambda returning the existing destination value or a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Resolve<global::TestCase.Source, global::TestCase.Destination, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="construct">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ConstructUsing<global::TestCase.Source, global::TestCase.Destination> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ResolveUsing<global::TestCase.Source, global::TestCase.Destination, global::TestCase.Destination> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="mapping">Lambda, method group, or delegate returning the final result.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/convert.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Convert<global::TestCase.Source?, global::TestCase.Destination> mapping)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.MemberExtension.ConstructMembersAfterMapper.SourceToDestination__23392b58600c0478a53aab16ab0fd569.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersAfterMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MemberExtension.ConstructMembersBeforeMapper.SourceToDestination__0bcf691cc3226b74a8cd073c31ed0ffa.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="members">Inline lambda. Unspecified members follow MemberSelection.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/members.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.ConstructMembersBeforeMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Members<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationMembers> members)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.TypeMapper.ConstructMembersAfterMapper__dbae12c4fca8192350c3ca020cf885af.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class ConstructMembersAfterMapper :
...
"""),
            ("Morphant.Generated.TypeMapper.ConstructMembersBeforeMapper__f1d0105a5ea0aae06cbaccfc2b21a163.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class ConstructMembersBeforeMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        /// <inheritdoc/>
        protected override bool Supports(
