...
[TestFixture]
internal sealed class SupportingCapturedTests
{
    [Test]
    public async Task Preserves_captured_member_local_initializers_and_values()
    {
        // lang=c#
        const string source =
"""
...
"""),
            ("Morphant.Generated.MappingExtension.CapturedConstructMapper.SourceToDestination__6fb22e867388a785741e308562e6828a.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MappingExtension.CapturedResolveMapper.SourceToDestination__c1dbe9b737e82f3540c2707da29490c7.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="construct">Inline lambda returning a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Construct<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Inline lambda returning the existing destination value or a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Resolve<global::TestCase.Source, global::TestCase.Destination, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="construct">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ConstructUsing<global::TestCase.Source, global::TestCase.Destination> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ResolveUsing<global::TestCase.Source, global::TestCase.Destination, global::TestCase.Destination> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="mapping">Lambda, method group, or delegate returning the final result.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/convert.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Convert<global::TestCase.Source?, global::TestCase.Destination> mapping)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.MemberExtension.CapturedConstructMapper.SourceToDestination__6fb22e867388a785741e308562e6828a.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MemberExtension.CapturedResolveMapper.SourceToDestination__c1dbe9b737e82f3540c2707da29490c7.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="members">Inline lambda. Unspecified members follow MemberSelection.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/members.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.CapturedResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Members<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationMembers> members)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.TypeMapper.CapturedConstructMapper__35f5cedbb0e91aa2ffc0397a60df35a4.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class CapturedConstructMapper :
...
"""),
            ("Morphant.Generated.TypeMapper.CapturedResolveMapper__606a8c87fb8ae2666c79e8947ac27652.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class CapturedResolveMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        /// <inheritdoc/>
        protected override bool Supports(
