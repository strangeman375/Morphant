...
[TestFixture]
internal sealed class SupportingStableTests
{
    [Test]
    public async Task Keeps_shared_user_locals_for_Construct_and_Resolve()
    {
        // lang=c#
        const string source =
"""
...
"""),
            ("Morphant.Generated.MappingExtension.StableConstructMapper.SourceToDestination__7c25159deab9d5419db4377d46f2b29f.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MappingExtension.StableResolveMapper.SourceToDestination__680f1647bd4b0fb5f22475d87bcc2817.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="construct">Inline lambda returning a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Construct<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Inline lambda returning the existing destination value or a construction expression.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Resolve<global::TestCase.Source, global::TestCase.Destination, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationConstruction> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="construct">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/construct-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ConstructUsing<global::TestCase.Source, global::TestCase.Destination> construct)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="resolve">Callback returning the destination; null ends the mapping.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/resolve-using.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.ResolveUsing<global::TestCase.Source, global::TestCase.Destination, global::TestCase.Destination> resolve)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
        ...
        /// <param name="mapping">Lambda, method group, or delegate returning the final result.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/convert.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Convert<global::TestCase.Source?, global::TestCase.Destination> mapping)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.MemberExtension.StableConstructMapper.SourceToDestination__7c25159deab9d5419db4377d46f2b29f.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.StableConstructMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MemberExtension.StableResolveMapper.SourceToDestination__680f1647bd4b0fb5f22475d87bcc2817.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        /// <param name="members">Inline lambda. Unspecified members follow MemberSelection.</param>
        /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/api/members.md"/>
        public static global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.StableResolveMapper, global::TestCase.Source, global::TestCase.Destination> builder,
            global::Morphant.Delegates.Members<global::TestCase.Source, global::Morphant.Generated.N_5e01468111660761710199b9666fe80e.DestinationMembers> members)
            => throw new global::Morphant.Exceptions.RuntimeInvocationNotSupportedException();
...
"""),
            ("Morphant.Generated.TypeMapper.StableConstructMapper__950851579fe4e831febd38028938d971.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class StableConstructMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::TestCase.Destination destination)
        {
            ...
            destination.Name = userCopy;
            destination.Label = userCopy;
...
"""),
            ("Morphant.Generated.TypeMapper.StableResolveMapper__269705a83112f99071f79b2dd55e5656.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class StableResolveMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        /// <inheritdoc/>
        protected override bool Supports(
