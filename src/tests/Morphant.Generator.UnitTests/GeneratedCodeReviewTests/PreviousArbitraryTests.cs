...
[TestFixture]
internal sealed class PreviousArbitraryTests
{
    [Test]
    public async Task Leaves_user_TryGetValue_calls_intact()
    {
        // lang=c#
        const string source =
"""
...
"""),
            ("Morphant.Generated.MappingExtension.ArbitraryMapper.SourceToDestination__29c226b00a13971ca4424ed388106ae8.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> Construct(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> Resolve(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> ConstructUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> ResolveUsing(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> Convert(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.MemberExtension.ArbitraryMapper.SourceToDestination__29c226b00a13971ca4424ed388106ae8.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace Morphant
{
    internal static partial class MorphantGeneratedMappingExtensions
    {
        ...
        public static global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> Members(
            this global::Morphant.MappingBuilder<global::TestCase.ArbitraryMapper, global::TestCase.Source, global::TestCase.Destination> builder,
...
"""),
            ("Morphant.Generated.TypeMapper.ArbitraryMapper__5f5b674134187ba0c8690335d117389a.g.cs",
            // lang=c#
"""
// <auto-generated />
#nullable enable
...
namespace TestCase
{
    public partial class ArbitraryMapper :
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Create(
            global::TestCase.Source source)
        {
            _ = source.TryGetValue(out global::TestCase.Destination? current);
        ...
        private global::TestCase.Destination __Update(
            ...
            global::TestCase.Destination destination)
        {
            if (source.TryGetValue(out global::TestCase.Destination? current) &&
                source.Decide(current))
            {
