...
""";
    ...
    [Test]
    public async Task Preserves_oblivious_reference_type_constraint()
    {
        // lang=c#
        const string source =
"""
...
""";
        ...
        await TemplateTypeGeneratorTest.RunAndAssert(
            ...
            source,
            GenericDestinationHintName,
            ExpectedObliviousConstrainedGenericTemplate);
    }
...
""";
    ...
    // lang=c#
    private const string ExpectedObliviousConstrainedGenericTemplate =
"""
// <auto-generated />
#nullable enable
