        ...
        DefaultVerifier>
{
        ...
        string scenarioTypeName)
    {
        ...
        var compilation = CSharpCompilation.Create(
            "MorphantConventionRuntime_" + Guid.NewGuid().ToString("N"),
            [syntaxTree],
            BuildReferences(),
        ...
        GeneratorDriver driver = CSharpGeneratorDriver.Create(
            [new TestConventionTypeMapperGenerator().AsSourceGenerator()],
        ...
        IEnumerable<Diagnostic> diagnostics)
    {
        ...
        Assert.That(
            failures,
            Is.Empty,
            string.Join(Environment.NewLine, failures.Select(
