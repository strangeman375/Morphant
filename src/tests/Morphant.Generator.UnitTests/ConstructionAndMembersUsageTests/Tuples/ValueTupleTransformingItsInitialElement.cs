...
internal sealed partial class TuplesTests
{
    ...
    public void ValueTupleTransformingItsInitialElement()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, (int Id, string Name)>()
                ...
                .Members((source, previous, result) => new() { Name = result.Name.ToUpperInvariant() });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, (int Id, string Name)>
    {
        ...
        private (int Id, string Name) __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Name = destination.Name.ToUpperInvariant();
