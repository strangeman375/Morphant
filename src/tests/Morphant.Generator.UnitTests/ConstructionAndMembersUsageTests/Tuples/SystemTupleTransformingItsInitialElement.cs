...
{
    [Test]
    [Description("Members transforms the initial value of the same element through result.")]
    public void SystemTupleTransformingItsInitialElement()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Tuple<int, string>>()
                ...
                .Members((source, previous, result) => new() { Item2 = result.Item2.ToUpperInvariant() });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::System.Tuple<int, string>>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            return new global::System.Tuple<int, string>(result.Item1, result.Item2.ToUpperInvariant());
        }
