...
{
    [Test]
    [Description("An independent replacement must not change the initial tuple seen by another member expression.")]
    public void SystemTupleKeepsEarlierMemberReadsOnInitialResult()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Tuple<int, string>>()
                ...
                .Members((_, _, result) => new() { Item1 = 42, Item2 = result.Item1.ToString() });
    }
}
""";
