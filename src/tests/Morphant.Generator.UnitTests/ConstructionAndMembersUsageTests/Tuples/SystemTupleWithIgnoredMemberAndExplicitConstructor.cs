...
{
    [Test]
    [Description("Ignoring the member leaves the tuple constructor value available.")]
    public void SystemTupleWithIgnoredMemberAndExplicitConstructor()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::System.Tuple<int, string>>
    {
        ...
        private global::System.Tuple<int, string> __Create(
            ...
            global::Morphant.Context.MappingContext context)
        {
            return new global::System.Tuple<int, string>(source.Id, source.FromConstruct());
        }
