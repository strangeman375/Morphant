...
{
    [Test]
    [Description("A named element is addressed through Item2 in Members; inspect whether that alias is exposed.")]
    public void NamedTupleElementConfiguredThroughItsPhysicalAlias()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, (int Id, string Name)>
    {
        ...
        private (int Id, string Name) __Create(
            ...
            global::Morphant.Context.MappingContext context)
        {
            return (Id: source.Id, Name: source.FromConstruct());
        }
...
""")
            ...
            expectedDiagnostics: """
CS0117 Error: 'TupleMembers' does not contain a definition for 'Item2'
  at TestCase.cs(26,44-26,49)
""");
    }
}
