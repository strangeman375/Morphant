...
{
    [Test]
    [Description("Equal constants are written for the same element twice.")]
    public void SystemTupleWithIdenticalConstantsForOneElement()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Tuple<int, string>>()
                ...
                .Construct(_ => new(7, "same"))
                .Members(_ => new() { Item2 = "same" });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::System.Tuple<int, string>>
    {
        ...
        private global::System.Tuple<int, string> __Create(
            ...
            global::Morphant.Context.MappingContext context)
        {
            return new global::System.Tuple<int, string>(7, "same");
        }
