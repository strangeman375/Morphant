...
{
    [Test]
    [Description("Construct supplies the elements while automatic member selection remains enabled.")]
    public void SystemTupleConstructorWithUnmentionedAutomaticMembers()
    {
        // lang=c#
        const string source =
"""
