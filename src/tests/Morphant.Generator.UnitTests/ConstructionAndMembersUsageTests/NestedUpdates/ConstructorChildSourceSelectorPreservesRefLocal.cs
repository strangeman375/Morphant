...
{
    [Test]
    [Description("A source selector retains mutations of a user-written local passed by reference.")]
    public void ConstructorChildSourceSelectorPreservesRefLocal()
    {
        // lang=c#
        const string source =
"""
