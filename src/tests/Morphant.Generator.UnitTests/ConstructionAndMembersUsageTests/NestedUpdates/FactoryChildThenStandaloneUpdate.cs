...
{
    [Test]
    [Description("The factory result keeps its readonly child reference while that child is updated.")]
    public void FactoryChildThenStandaloneUpdate()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder)
        {
            ...
            builder.Map<Source, Destination>()
                ...
                .ConstructUsing(_ => new Destination(new ChildDestination()))
