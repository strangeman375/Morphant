...
{
    [Test]
    [Description("A conditional standalone update shares its continuation and retains only the necessary operation guard.")]
    public void ConstructorChildUpdateOnlyDuringUpdate()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    public sealed class Source
    {
        ...
        public ChildSource ReadChild(MappingOperation operation) => Child;
    }
