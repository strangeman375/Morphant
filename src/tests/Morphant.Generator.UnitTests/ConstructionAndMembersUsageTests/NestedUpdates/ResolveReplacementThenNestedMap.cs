...
{
    [Test]
    [Description("Nested Map uses the selected result child while preserving the outer operation.")]
    public void ResolveReplacementThenNestedMap()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: ResolveReplacementThenNestedMapSurfaces);
    }
}
