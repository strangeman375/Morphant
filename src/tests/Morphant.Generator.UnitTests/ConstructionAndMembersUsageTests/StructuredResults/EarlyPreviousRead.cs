    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                ...
                {
                    Construction selected = previous.Value;
                    if (previous.HasValue) return selected;
...
""")
            ...
            expectedDiagnostics:
"""
MORPH0038 Error: 'previous' is unavailable in mapping 'TestCase.Source -> TestCase.Destination'. Affected cases: Create; Update without an existing destination.
  at TestCase.cs(26,45-26,59)
""");
    }
}
