...
{
    [Test]
    public void StoredAvailabilityGuard()
    {
        // lang=c#
        const string source =
"""
        ...
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Resolve((source, previous) =>
                {
                    ...
                    if (available) return previous.Value;
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Create(
            ...
            global::Morphant.Context.MappingContext context)
        {
            var available = global::Morphant.Option<global::TestCase.Destination>.None.HasValue;
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            var available = global::Morphant.Option<global::TestCase.Destination>.Some(destination).HasValue;
