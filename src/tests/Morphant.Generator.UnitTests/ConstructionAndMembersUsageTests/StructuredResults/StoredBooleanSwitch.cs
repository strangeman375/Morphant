...
{
    [Test]
    public void StoredBooleanSwitch()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                ...
                {
                    if (!previous.HasValue) return new(source.FromConstruct());
                    Construction selected = source.Reuse switch
                    {
                        true => previous.Value,
                        false => new Construction(source.FromConstruct())
                    };
                    return selected;
                })
