...
{
    [Test]
    public void ArbitraryDestinationRecovery()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedDiagnostics:
"""
MORPH0062 Error: Resolve for mapping 'TestCase.Source -> TestCase.Destination' must return the existing destination from previous or a construction expression. Use ResolveUsing to return another destination object.
  at TestCase.cs(28,28-28,40)
""");
    }
}
