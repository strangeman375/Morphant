...
internal sealed partial class EvaluationOrderTests
{
    [TestCase(false)]
    [TestCase(true)]
    [Description("Constructor arguments and member computations preserve their internal line breaks.")]
    public void MultilineConstructorAndMemberValues(bool crlf)
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(string.Concat(
                    source.FromConstruct(),
                    source.Name)))
                .Members(source => new()
                {
                    Name = source.Name == "allowed"
                          ? source.FromMembers() // Keep the selected name.
                          : source.FromConstruct()
                });
    }
}
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Name = source.Name == "allowed"
                  ? source.FromMembers() // Keep the selected name.
                  : source.FromConstruct();
