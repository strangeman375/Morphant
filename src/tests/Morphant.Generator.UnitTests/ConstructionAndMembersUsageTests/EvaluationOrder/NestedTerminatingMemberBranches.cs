...
{
    [Test]
    [Description("Nested returns, throws and an inner local keep only the selected path.")]
    public void NestedTerminatingMemberBranches()
    {
        // lang=c#
        const string source =
"""
        ...
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                ...
                .Members(source =>
                {
                    ...
                    {
                        if (source.FromConstruct() == "from constructor")
                            return new() { Name = source.FromMembers() };
                        throw new System.InvalidOperationException("inner branch");
                    }
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            if (source.Name == "allowed")
            {
                ...
                throw new global::System.InvalidOperationException("inner branch");
            }
