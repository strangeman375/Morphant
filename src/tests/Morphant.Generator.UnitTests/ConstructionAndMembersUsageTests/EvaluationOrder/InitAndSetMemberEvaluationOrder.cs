...
{
    [Test]
    [Description("Creation combines an init property and a writable property whose expressions have side effects.")]
    public void InitAndSetMemberEvaluationOrder()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(source.Next()))
                .Members(source => new() { First = source.Next(), Second = source.Next() });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Second = source.Next();
...
""")
            ...
            expectedSurfaces: InitAndSetMemberEvaluationOrderSurfaces);
    }
}
