...
{
    [Test]
    [Description("Equivalent conditional expressions keep their own calls and short-circuit behavior.")]
    public void ShortCircuitCallsRemainIndependent()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(source.Next() > 0 ? source.Next() : 0, 2))
                .Members(source => new() { Left = source.Next() > 0 ? source.Next() : 0 });
    }
}
""";
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            return new global::TestCase.Destination(
                left: source.Next() > 0 ? source.Next() : 0,
                right: 2)
            {
                Left = source.Next() > 0 ? source.Next() : 0
            };
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Left = source.Next() > 0 ? source.Next() : 0;
