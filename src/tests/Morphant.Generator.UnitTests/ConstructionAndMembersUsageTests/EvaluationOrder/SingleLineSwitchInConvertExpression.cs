...
{
    [Test]
    [Description("A transferred expression-bodied callback keeps a nested switch on one line.")]
    public void SingleLineSwitchInConvertExpression()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Convert(source => new Destination(source switch { null => "missing", _ => string.Concat(source.Name, source.FromMembers()) }));
    }
}
""";
