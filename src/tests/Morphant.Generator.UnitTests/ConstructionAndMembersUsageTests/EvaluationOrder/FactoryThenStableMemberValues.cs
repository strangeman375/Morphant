...
{
    [Test]
    [Description("A factory result is initialized before member values and assignments.")]
    public void FactoryThenStableMemberValues()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .ConstructUsing(source => new Destination(source.Next(), 2))
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __ConstructUsing(global::TestCase.Source source) => new global::TestCase.Destination(source.Next(), 2);
    }
}
""")
            ],
