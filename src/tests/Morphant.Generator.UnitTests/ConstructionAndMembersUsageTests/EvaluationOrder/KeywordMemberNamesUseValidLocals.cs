...
{
    [Test]
    [Description("Member names that become C# keywords still produce legal readable local variables.")]
    public void KeywordMemberNamesUseValidLocals()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    {
        public Destination(int left, int right) { Explicit = left; Event = right; }
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(_ => new(1, 2))
                .Members((_, _, result) => new() { Explicit = result.Event, Event = result.Explicit });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            int @explicit = result.Event;
            int @event = result.Explicit;
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            int @explicit = destination.Event;
            int @event = destination.Explicit;
...
""")
            ...
            expectedSurfaces: KeywordMemberNamesUseValidLocalsSurfaces);
    }
}
