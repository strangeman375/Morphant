...
{
    [Test]
    [Description("An unrelated Members branch must not reapply the convention for a constructor-initialized member.")]
    public void UnmentionedMemberKeepsExplicitConstructorAcrossBranches()
    {
        // lang=c#
        const string source =
"""
