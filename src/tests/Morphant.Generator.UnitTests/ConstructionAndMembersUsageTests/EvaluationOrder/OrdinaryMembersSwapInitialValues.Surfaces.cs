...
{
    private static readonly (string HintName, string Source)[] OrdinaryMembersSwapInitialValuesSurfaces =
    [
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    {
        /// <summary>
        /// Maps the <c>left</c> argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<int> left = null!;

        /// <summary>
        /// Maps the <c>right</c> argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<int> right = null!;
    }
    ...
    internal sealed class DestinationConstruction
    {
        ...
        /// </summary>
        /// <param name="left">Maps the <c>left</c> argument.</param>
        /// <param name="right">Maps the <c>right</c> argument.</param>
        public DestinationConstruction(
            global::Morphant.Members.ConstructorParameter<int> left,
            global::Morphant.Members.ConstructorParameter<int> right)
        {
        }
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    {
        /// <summary>
        /// Maps <see cref="global::TestCase.Destination.Left"/>.
        /// </summary>
        ...
        /// <summary>
        /// Maps <see cref="global::TestCase.Destination.Right"/>.
        /// </summary>
