...
{
    [Test]
    [Description("A scalar switch expression keeps its user-written arm layout.")]
    public void MultilineSwitchValue()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                ...
                .Members(source => new()
                {
                    Name = source.Name switch
                    {
                        "allowed" => string.Concat(
                            source.FromMembers(),
                            source.Name),
                        _ => source.FromConstruct()
                    }
                });
    }
}
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Name = source.Name switch
            {
                "allowed" => string.Concat(
                    source.FromMembers(),
                    source.Name),
