...
{
    [Test]
    [Description("The constructor itself throws; an unrelated member call makes evaluation order visible.")]
    public void ThrowingConstructorWithIndependentMemberExpression()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    {
        public Destination(string name) => throw new System.InvalidOperationException(name);
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                ...
                .Members(source => new() { Label = source.FromMembers() });
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Label = source.FromMembers();
...
""")
            ...
            expectedSurfaces: ThrowingConstructorWithIndependentMemberExpressionSurfaces);
    }
}
