...
internal sealed partial class EvaluationOrderTests
{
    ...
    public void UserWrittenMapCallsKeepTheirArguments()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    public sealed class Source
    {
        ...
        public Calls Mapper { get; } = new();
    }

    public sealed class Calls
    {
        public TDestination Map<TSource, TDestination>(TSource source, TDestination destination) => destination;
    }
        ...
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(source.Read(1),
                    source.Mapper.Map<int, int>(source.Read(2), destination: source.Enabled ? 3 : 4)))
                .Members(source => new()
                {
                    Value = source.Mapper.Map<int, int>(source.Read(5), destination: source.Enabled ? 6 : 7)
                });
    }
}
""";
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            return new global::TestCase.Destination(
                first: source.Read(1),
                value: source.Mapper.Map<int, int>(source.Read(2), destination: source.Enabled ? 3 : 4))
            {
                Value = source.Mapper.Map<int, int>(source.Read(5), destination: source.Enabled ? 6 : 7)
            };
        }
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Value = source.Mapper.Map<int, int>(source.Read(5), destination: source.Enabled ? 6 : 7);
