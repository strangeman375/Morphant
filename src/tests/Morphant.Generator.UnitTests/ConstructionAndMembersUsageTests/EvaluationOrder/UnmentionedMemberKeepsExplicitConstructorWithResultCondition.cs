...
{
    [Test]
    [Description("Reading result in a branch must not reapply an unmentioned conventional member.")]
    public void UnmentionedMemberKeepsExplicitConstructorWithResultCondition()
    {
        // lang=c#
        const string source =
"""
