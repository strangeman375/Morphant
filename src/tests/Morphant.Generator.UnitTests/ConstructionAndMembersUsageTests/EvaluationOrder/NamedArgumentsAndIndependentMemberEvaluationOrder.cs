...
{
    [Test]
    [Description("Named arguments are written out of parameter order; an unrelated member has its own call.")]
    public void NamedArgumentsAndIndependentMemberEvaluationOrder()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(second: source.Read("second"), first: source.Read("first")))
