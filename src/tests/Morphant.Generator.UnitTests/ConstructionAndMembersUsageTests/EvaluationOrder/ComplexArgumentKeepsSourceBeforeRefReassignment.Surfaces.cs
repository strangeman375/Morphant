...
{
    private static readonly (string HintName, string Source)[] ComplexArgumentKeepsSourceBeforeRefReassignmentSurfaces =
    [
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    {
        /// <summary>
        /// Maps the <c>original</c> argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<global::TestCase.Source> original = null!;
    ...
    internal sealed class DestinationConstruction
    {
        ...
        /// </summary>
        /// <param name="original">Maps the <c>original</c> argument.</param>
        /// <param name="value">Maps the <c>value</c> argument.</param>
        public DestinationConstruction(
            global::Morphant.Members.ConstructorParameter<global::TestCase.Source> original,
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    {
        /// <summary>
        /// Selects <see cref="global::TestCase.Destination.Original"/> for a nested Update.
        /// </summary>
        public global::Morphant.Members.Member<global::TestCase.Source> Original
        {
            get => null!;
        }
