...
{
    [Test]
    [Description("The constructor expression throws if it is evaluated; Members supplies another value.")]
    public void ThrowingConstructorExpressionWithMemberOverride()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    {
        public string FromConstruct() => throw new System.InvalidOperationException("constructor expression");
        public string FromMembers() => "member value";
    }
