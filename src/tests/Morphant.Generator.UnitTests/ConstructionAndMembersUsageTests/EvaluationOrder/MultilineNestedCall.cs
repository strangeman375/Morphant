...
{
    [Test]
    [Description("An explicitly nested mapping keeps the user argument layout.")]
    public void MultilineNestedCall()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            {
                Name = context.Mapper.Map<string, string>(
                    string.Concat(
                        source.FromMembers(),
                        source.Name))
            };
        ...
        private global::TestCase.Destination __Update(
            ...
            global::Morphant.Context.MappingContext context)
        {
            destination.Name = context.Mapper.Map<string, string>(
                string.Concat(
                    source.FromMembers(),
                    source.Name));
