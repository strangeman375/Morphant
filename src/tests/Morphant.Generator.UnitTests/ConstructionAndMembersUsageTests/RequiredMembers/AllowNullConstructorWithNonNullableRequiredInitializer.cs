...
{
    [Test]
    [Description("A nullable constructor argument cannot supply the non-nullable required initializer; its convention remains independent.")]
    public void AllowNullConstructorWithNonNullableRequiredInitializer()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: NullableConstructorWithNonNullableRequiredInitializerSurfaces,
