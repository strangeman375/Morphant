...
{
    [Test]
    [Description("Resolve applies explicit required init rules on replacement even with SetsRequiredMembers, but skips them on reuse.")]
    public void ResolveTwoExplicitValuesForRequiredInitWithSetsRequiredMembers()
    {
        // lang=c#
        const string source =
"""
