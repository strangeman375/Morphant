...
{
    [Test]
    [Description("Resolve applies a required setter after both construction and reuse, independently of constructor values.")]
    public void ResolveTwoExplicitValuesForRequiredSet()
    {
        // lang=c#
        const string source =
"""
