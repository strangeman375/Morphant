...
{
    [Test]
    [Description("Reversing the fluent configuration order does not express a different runtime order.")]
    public void MembersWrittenBeforeConstruct()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: MembersWrittenBeforeConstructSurfaces);
    }
}
