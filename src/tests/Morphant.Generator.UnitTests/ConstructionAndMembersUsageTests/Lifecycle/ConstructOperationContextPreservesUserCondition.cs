...
{
    [Test]
    [Description("Construct omits identical generated operation branches while preserving an effectful user condition with identical results.")]
    public void ConstructOperationContextPreservesUserCondition()
    {
        // lang=c#
        const string source =
"""
