...
{
    [Test]
    [Description("A runtime source condition chooses an explicit member value or Ignore.")]
    public void MemberRuleUnderAnOrdinarySourceCondition()
    {
        // lang=c#
        const string source =
"""
