...
{
    [Test]
    [Description("Construct and Members keep the actual operation when a null Update destination requires construction.")]
    public void ConstructOperationContextWithPreviousAndResult()
    {
        // lang=c#
        const string source =
"""
