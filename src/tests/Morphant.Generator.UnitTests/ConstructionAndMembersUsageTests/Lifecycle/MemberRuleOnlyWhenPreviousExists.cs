...
{
    [Test]
    [Description("Construct has a value; Members ignores creation paths and supplies a value only when previous exists.")]
    public void MemberRuleOnlyWhenPreviousExists()
    {
        // lang=c#
        const string source =
"""
