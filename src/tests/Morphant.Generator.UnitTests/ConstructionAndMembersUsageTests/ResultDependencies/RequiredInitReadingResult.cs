...
{
    [Test]
    [Description("A required member reads result after an explicitly requested constructor.")]
    public void RequiredInitReadingResult()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: ExplicitConstructorThenReadingResultSurfacesFileScoped,
            expectedDiagnostics: """
