...
{
    [Test]
    [Description("The ValueTuple returned by a factory is subsequently changed by Members.")]
    public void ValueTupleFactoryThenMemberAssignment()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, (int Id, string Name)>()
                ...
                .ConstructUsing(source => (source.Id, source.FromConstruct()))
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, (int Id, string Name)>
    {
        ...
        private (int Id, string Name) __Create(
            ...
            global::Morphant.Context.MappingContext context)
        {
            (int Id, string Name) result = __ConstructUsing(source);
        ...
        private (int Id, string Name) __ConstructUsing(global::TestCase.Source source) => (source.Id, source.FromConstruct());
    }
}
""")
            ],
