...
internal sealed partial class FactoriesTests
{
    ...
    public void ConstructUsingReturnsNullBeforeMembers()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
        ...
        private global::TestCase.Destination __ConstructUsing(global::TestCase.Source source) => null!;
    }
}
""")
            ],
