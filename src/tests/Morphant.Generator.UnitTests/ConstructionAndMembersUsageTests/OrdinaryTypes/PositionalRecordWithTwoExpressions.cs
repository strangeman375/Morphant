...
{
    [Test]
    [Description("A positional record has two expressions for the same name.")]
    public void PositionalRecordWithTwoExpressions()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: PositionalRecordWithTwoExpressionsSurfaces);
    }
}
