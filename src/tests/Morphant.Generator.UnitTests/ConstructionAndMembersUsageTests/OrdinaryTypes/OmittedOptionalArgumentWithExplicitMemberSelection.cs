...
{
    [Test]
    [Description("An omitted optional argument when only explicitly selected members are mapped.")]
    public void OmittedOptionalArgumentWithExplicitMemberSelection()
    {
        // lang=c#
        const string source =
"""
