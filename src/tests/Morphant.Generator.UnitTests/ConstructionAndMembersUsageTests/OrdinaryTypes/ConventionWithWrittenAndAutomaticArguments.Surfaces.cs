...
{
    private static readonly (string HintName, string Source)[] ConventionWithWrittenAndAutomaticArgumentsSurfaces =
    [
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    internal sealed class DestinationConstructorParameters
    {
        ...
        /// <summary>
        /// Maps the <c>age</c> argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<int> age = null!;

        /// <summary>
        /// Maps the <c>score</c> argument.
        /// </summary>
        public global::Morphant.Members.ConstructorParameter<int> score = null!;
    }
    ...
    internal sealed class DestinationConstruction
    {
        ...
        /// <param name="age">Maps the <c>age</c> argument.</param>
        /// <param name="score">Maps the <c>score</c> argument.</param>
        public DestinationConstruction(
            global::Morphant.Members.ConstructorParameter<string> name,
            global::Morphant.Members.ConstructorParameter<int> age,
            global::Morphant.Members.ConstructorParameter<int> score)
        {
        }
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    internal sealed record DestinationMembers
    {
        ...
        /// <summary>
        /// Maps <see cref="global::TestCase.Destination.Age"/>.
        /// </summary>
        public global::Morphant.Members.Member<int> Age
        {
            get => null!;
            set { }
        }
        ...
        /// <summary>
        /// Maps <see cref="global::TestCase.Destination.Score"/>.
        /// </summary>
        public global::Morphant.Members.Member<int> Score
        {
            get => null!;
            set { }
        }
