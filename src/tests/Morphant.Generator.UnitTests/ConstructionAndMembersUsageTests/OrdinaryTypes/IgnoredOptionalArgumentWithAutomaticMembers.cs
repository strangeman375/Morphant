...
{
    [Test]
    [Description("Ignore omits an optional argument while member conventions remain enabled.")]
    public void IgnoredOptionalArgumentWithAutomaticMembers()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: OmittedOptionalArgumentWithMemberValueSurfaces);
    }
}
