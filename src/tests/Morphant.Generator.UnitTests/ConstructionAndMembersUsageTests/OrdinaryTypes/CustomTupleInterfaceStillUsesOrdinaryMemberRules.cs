...
{
    [Test]
    [Description("A user-defined ITuple implementation is an ordinary object rather than a BCL tuple.")]
    public void CustomTupleInterfaceStillUsesOrdinaryMemberRules()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    public sealed class Destination : System.Runtime.CompilerServices.ITuple
    {
        public Destination(string name) => Name = name;
        public string Name { get; set; }
        int System.Runtime.CompilerServices.ITuple.Length => 1;
        object? System.Runtime.CompilerServices.ITuple.this[int index] => Name;
    }
