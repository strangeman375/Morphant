...
{
    [Test]
    [Description("The explicit constructor argument is non-null, but the member independently accepts null.")]
    public void ExplicitConstructorWithNullableMemberValue()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(_ => new("constructor value"))
