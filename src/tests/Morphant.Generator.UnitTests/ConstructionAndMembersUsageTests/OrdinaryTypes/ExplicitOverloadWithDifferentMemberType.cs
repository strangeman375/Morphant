...
{
    [Test]
    [Description("An explicit object overload is selected although the member supplies a string.")]
    public void ExplicitOverloadWithDifferentMemberType()
    {
        // lang=c#
        const string source =
"""
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new(Value<object>(source.FromConstruct())))
