...
{
    [Test]
    [Description("Constructor and member conversions execute independently even for the same source property.")]
    public void IndependentUserDefinedConversions()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    public sealed class Source { public Input Value => new(); }
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source, Destination>()
                .Construct(source => new((int)source.Value))
