...
internal sealed partial class OrdinaryTypesTests
{
    ...
    public void NarrowingMemberValueIntoConstructor()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: NarrowingMemberValueIntoConstructorSurfaces,
            expectedDiagnostics: """
MORPH0036 Error: ConstructorSelection.Unambiguous cannot select a constructor for mapping 'TestCase.Source -> TestCase.Destination': constructor 'TestCase.Destination(int name)' cannot be called with the mapped arguments.
  at TestCase.cs(21,21-21,24); TestCase.cs(13,16-13,27)
""");
    }
}
