...
{
    [Test]
    [Description("Resolve preserves explicit, Auto and unspecified ByConvention arguments on replacement and member rules on reuse.")]
    public void ResolveConventionWithWrittenAndAutomaticArguments()
    {
        // lang=c#
        const string source =
"""
