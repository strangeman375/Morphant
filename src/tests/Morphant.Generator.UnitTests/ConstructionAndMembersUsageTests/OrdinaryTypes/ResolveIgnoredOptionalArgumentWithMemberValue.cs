...
{
    [Test]
    [Description("Resolve keeps an ignored optional constructor default and applies the independent member rule.")]
    public void ResolveIgnoredOptionalArgumentWithMemberValue()
    {
        // lang=c#
        const string source =
"""
