...
{
    [Test]
    [Description("Resolve keeps an omitted optional constructor default and applies the independent member rule.")]
    public void ResolveOmittedOptionalArgumentWithMemberValue()
    {
        // lang=c#
        const string source =
"""
