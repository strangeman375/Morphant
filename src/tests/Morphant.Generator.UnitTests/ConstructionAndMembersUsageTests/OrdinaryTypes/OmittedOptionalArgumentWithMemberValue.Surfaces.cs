...
{
    private static readonly (string HintName, string Source)[] OmittedOptionalArgumentWithMemberValueSurfaces =
    [
...
namespace Morphant.Generated.N_78409e4ae9aaeef534a067d95eb70f27
{
    ...
    internal sealed class DestinationConstruction
    {
        ...
        /// </summary>
        /// <param name="name">Maps the <c>name</c> argument. If omitted, uses <c>"constructor default"</c>.</param>
        public DestinationConstruction(global::Morphant.Members.ConstructorParameter<string> name = null!)
        {
        }
