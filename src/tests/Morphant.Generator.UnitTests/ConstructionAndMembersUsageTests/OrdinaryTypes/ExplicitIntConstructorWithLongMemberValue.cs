...
{
    [Test]
    [Description("The constructor accepts int while an independently configured member accepts long.")]
    public void ExplicitIntConstructorWithLongMemberValue()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    {
        public Destination(int name) => Name = name;
