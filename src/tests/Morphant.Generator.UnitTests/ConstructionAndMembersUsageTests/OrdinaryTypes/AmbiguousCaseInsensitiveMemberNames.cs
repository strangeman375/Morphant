...
{
    [Test]
    [Description("The constructor parameter differs in case from two possible corresponding members.")]
    public void AmbiguousCaseInsensitiveMemberNames()
    {
        // lang=c#
        const string source =
"""
...
""")
            ...
            expectedSurfaces: AmbiguousCaseInsensitiveMemberNamesSurfaces);
    }
}
