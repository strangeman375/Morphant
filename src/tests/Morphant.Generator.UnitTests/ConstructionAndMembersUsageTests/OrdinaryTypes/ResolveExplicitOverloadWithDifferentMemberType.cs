...
{
    [Test]
    [Description("Resolve keeps the constructor overload selected by Value<object>, independently of the member value.")]
    public void ResolveExplicitOverloadWithDifferentMemberType()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    ...
    {
        public Destination(object name) => Name = "object: " + name;
        public Destination(string name) => Name = "string: " + name;
            ...
            builder.Map<Source, Destination>()
                .Resolve((source, previous) =>
                {
                    if (previous.TryGetValue(out var current) && source.Reuse)
                        return current;
                    return new(Value<object>(source.FromConstruct()));
                })
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source, global::TestCase.Destination>
    {
            ...
            global::TestCase.Source source)
        {
            return new global::TestCase.Destination(
                name: (object)(source.FromConstruct()))
            {
...
""")
            ...
            expectedSurfaces: ExplicitOverloadWithDifferentMemberTypeSurfaces);
    }
}
