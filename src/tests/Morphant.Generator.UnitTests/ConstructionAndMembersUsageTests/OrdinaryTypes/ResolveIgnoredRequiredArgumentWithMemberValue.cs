...
{
    [Test]
    [Description("Resolve reports an ignored nonoptional constructor argument even when Members supplies the corresponding member.")]
    public void ResolveIgnoredRequiredArgumentWithMemberValue()
    {
        // lang=c#
        const string source =
"""
...
MORPH0037 Error: Rule for constructor parameter 'name' is invalid in mapping 'TestCase.Source -> TestCase.Destination': Ignore can only omit an optional or params parameter.
  at TestCase.cs(32,32-32,38); TestCase.cs(19,16-19,27)
""");
    }
}
