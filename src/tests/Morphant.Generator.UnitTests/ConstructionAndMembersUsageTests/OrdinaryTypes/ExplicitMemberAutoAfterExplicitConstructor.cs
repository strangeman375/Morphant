...
{
    [Test]
    [Description("Members explicitly requests Auto after an explicit constructor argument.")]
    public void ExplicitMemberAutoAfterExplicitConstructor()
    {
        // lang=c#
        const string source =
"""
