...
{
    [Test]
    [Description("Even identical written values can matter when the constructor and member assignment invoke a setter.")]
    public void IdenticalConstantsWithObservableSetter()
    {
        // lang=c#
        const string source =
"""
