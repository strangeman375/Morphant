...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source<T>, global::TestCase.Destination<T>>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            {
                Boxed = (source.Details is { } details ? details.Boxed : default(object?))
            };
        }
...
""";
    ...
    [Test]
    public async Task Resolves_guard_name_collisions_readably()
    {
        // lang=c#
        const string source =
"""
...
namespace TestCase
{
    public sealed class Source<T>
    {
        public Wrapper<T>? Context { get; init; }
    }

    public sealed class Wrapper<T>
    {
        public Details<T>? Class { get; init; }
    }
    ...
    public partial class TestMapper<T> : TypeMapper
    {
        protected override void Configure(MapperBuilder builder) =>
            builder.Map<Source<T>, Destination>()
                .IncludeMembers(source => source.Context?.Class);
    }
}
""";
...
namespace TestCase
{
        ...
        global::Morphant.ITypeMapper<global::TestCase.Source<T>, global::TestCase.Destination>
    {
            ...
            global::Morphant.Context.MappingContext context)
        {
            ...
            {
                Boxed = (source.Context is { } context1 && context1.Class is { } @class ? @class.Boxed : default(object?))
            };
        }
