...
internal sealed class DiagnosticCatalogAuditTests
{
    ...
    private static readonly CatalogEntry[] ExpectedCatalog =
    {
        ...
        new("MORPH0052", "Morphant.Polymorphism", DiagnosticSeverity.Error),
        ...
        new("MORPH0061", "Morphant.Polymorphism", DiagnosticSeverity.Error),
        new("MORPH0062", "Morphant.Construction", DiagnosticSeverity.Error)
    };
