...
[TestFixture]
internal sealed class FormsTests
{
    [Test]
    public void Executes_all_four_forms_in_constructor_and_member_targets()
    {
        // lang=c#
        const string source =
"""
    ...
    public static class Scenario
    {
        public static void Verify()
        {
            ...
            provider.Add<ITypeMapper<ChildSource, ChildDestination>>(
                child);
            provider.Add<ITypeMapper<ChildSource, IChildDestination>>(
                child);
