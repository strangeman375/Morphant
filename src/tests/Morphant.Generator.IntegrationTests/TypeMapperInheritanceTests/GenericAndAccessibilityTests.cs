...
internal sealed class GenericAndAccessibilityTests
{
    ...
    public void Provides_the_open_configuration_surface_for_a_closed_base()
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_f2272e41.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_9abffc73.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_a15526de.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_242822d4.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_33e35b5a.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .GenericAndAccessibility_d13d9d85.Scenario.Verify();
    }
}
