...
internal sealed class RegistrationDiagnosticsTests
{
    ...
    public void Throws_for_both_operations_of_a_suppressed_unsupported_contract()
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .RegistrationUnsupported_31a8b6c2.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .RegistrationUnification_f1407a2c.Scenario.Verify();
    }
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios
            .RegistrationUnavailable_2d0c31af.Scenario.Verify();
    }
    ...
    {
        using var workspace = new ConsumerBuildWorkspace();
        var build = await workspace.BuildConsumer("RegistrationOverrides");
        var diagnostics = CompilerDiagnosticOutput.Read(build.Process.Output);
