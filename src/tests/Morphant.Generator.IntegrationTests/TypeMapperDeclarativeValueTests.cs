...
internal sealed class TypeMapperDeclarativeValueTests
{
    ...
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios.DeclarativeValueMembers_4d90a101.Scenario.Verify();
    }

    [Test]
    public void Preserves_value_constructor_binding_and_evaluation_order()
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios.DeclarativeValueConstructors_4d90a102.Scenario.Verify();
    }

    [Test]
    public void Rejects_mismatched_and_runtime_intrinsics_fail_closed()
    {
        global::Morphant.Generator.IntegrationTests.CSharp9.Scenarios.DeclarativeValueFailures_4d90a103.Scenario.Verify();
    }
