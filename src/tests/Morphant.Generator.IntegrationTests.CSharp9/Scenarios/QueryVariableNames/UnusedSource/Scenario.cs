...
using System.Linq;
using Morphant;
namespace Morphant.Generator.IntegrationTests.CSharp9.Scenarios.QueryVariableNames.UnusedSource
{
    ...
    public static class Scenario
    {
        public static void Verify()
        {
            ...
            if (destination.InitialValue != "1,2" || destination.Value != "1,2")
            ...
            if (!ReferenceEquals(updated, destination) ||
                updated.InitialValue != "1,2" || updated.Value != "1,2")
