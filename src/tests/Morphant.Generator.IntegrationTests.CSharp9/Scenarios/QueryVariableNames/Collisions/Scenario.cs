...
using System.Linq;
using Morphant;
namespace Morphant.Generator.IntegrationTests.CSharp9.Scenarios.QueryVariableNames.Collisions
{
    ...
    public static class Scenario
    {
        public static void Verify()
        {
            ...
            if (destination.InitialValue != "6,9,9" ||
            ...
            if (!ReferenceEquals(updated, destination) ||
                destination.InitialValue != "6,9,9" ||
                destination.Value != "3")
            {
                throw new global::System.InvalidOperationException(
