...
using Morphant;
namespace Morphant.Generator.IntegrationTests.CSharp9.Scenarios.ExtensionInvocations.CollectionIndexExpression
{
    ...
    public partial class Mapper : TypeMapper<Mapper>
    {
        ...
        protected override void Configure(MapperBuilder builder) => builder.Map<int, string>().Convert(source => new Indexed { [Next()] = { source, source + 1 } }.Bag.Value);
    }
