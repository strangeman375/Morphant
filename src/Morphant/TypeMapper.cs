    ...
    where TMapper : TypeMapper<TMapper>
{
    ...
    /// <summary>
    /// Maps a value inferred by name, updating an available current destination
    /// or creating a nested value when none is available.
    /// </summary>
    ...
    /// <summary>
    /// Maps a supplied value, updating an available current destination
    /// or creating a nested value when none is available.
    /// </summary>
    ...
    /// <summary>
    /// Maps a value inferred by name to <typeparamref name="T"/>, updating an
    /// available current destination or creating a nested value.
    /// </summary>
    ...
    /// <summary>
    /// Maps a supplied value to <typeparamref name="T"/>, updating an available
    /// current destination or creating a nested value.
    /// </summary>
    /// <typeparam name="T">The nested destination type.</typeparam>
    /// <param name="source">The source passed to the nested mapping.</param>
    /// <seealso href="https://github.com/strangeman375/Morphant/blob/main/docs/nested-mapping.md"/>
