...
Редакция 14: пользователь утвердил ByName как library default для разных
enum и enum-to-string. ByValue выбирается через обычные уровни настройки.
...
этапа, конвенция перед завершающей веткой, числовое строковое представление, сохранение числа,
