...
Редакция 12: ByName сначала ищет точное совпадение через Ordinal и только
при его отсутствии пробует OrdinalIgnoreCase, как подбор параметров
конструктора. Категория закрытых решений и спорные вопросы — в разделе 10.
...
сопоставление имён в два этапа, числовое строковое представление, сохранение числа,
...
|---|---|---|
| Сравнение имён `ByName` | Сначала `Ordinal`, при отсутствии точного совпадения — `OrdinalIgnoreCase`; оба этапа независимы от culture | Как подбор параметров конструктора, по уточнению пользователя; разделы 4 и 7. Выбор стратегии по умолчанию остаётся отдельным вопросом |
