...
Редакция 10: оставшиеся вопросы разделены на очевидные и спорные.
Первая категория зафиксирована как контракт дизайна по поручению пользователя;
вторая содержит развилки, которые ещё требуют обсуждения (раздел 10).
...
точное сравнение имён, числовое строковое представление, сохранение числа,
...
фиксируется exact ordinal: сравнение регистрозависимо и не зависит от culture,
как существующая конвенция прямых имён members. Выбор критерия по умолчанию
...
|---|---|---|
| Сравнение имён `ByName` | Exact ordinal; регистр значим, culture не участвует | Продолжает конвенцию прямых member names; раздел 4. Выбор стратегии по умолчанию остаётся отдельным вопросом |
