...
2026-09-06 пользователь утвердил общее правило именования и разрешил
реализацию правила и исправлений всех находок этапа. Работа начата;
спорные изменения публичного поведения согласуются отдельно. Этап 5 не начат.
...
Утверждено пользователем 2026-09-06; реализация разрешена и начата.
...
После внедрения явные `using`, aliases и полные имена потребуется обновить.
...
лишнего дублирования типов. Проверки нового правила ещё не выполнены.
...
До этапа 5 выполнить разрешённые исправления S04-01/S04-03/S04-04, затем поправить
...
Namespace-дизайн S04-05 утверждён выше. Представление конфликтующих имён
в явном Members требует отдельного обсуждения, если исправление меняет
пользовательские имена или форму generated-типа.
