...
{
    [MorphantMapper]
    public abstract partial class ProducerMapper<TMapper, T> : TypeMapper<TMapper>
...
{
    [MorphantMapper]
    public abstract partial class ConsumerMapper<TMapper, T> : Producer.ProducerMapper<TMapper, T>
