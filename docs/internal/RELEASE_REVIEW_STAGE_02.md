...
| Явное создание | `Construct(s => new(...))`, при необходимости `Members` | Компактно, сохраняет управление creation-only правилами. Нужно явно объяснить target-typed синтаксис; S02-03 |
