...
2026-09-23. Основные режимы согласованы; строковые списки вновь обсуждаются.
...
Применение к ByMask, integer/обычному enum → flags и алгоритм без перебора подмножеств —
...
После review решено проработать списки flags-имён и обратный parsing. Их контракт
ещё не принят: нужны единица правил, composite names, aliases, порядок,
разделители и реакция на неизвестный токен/бит.

## Строковые flags

2026-09-23. Проверенные форматы; контракт Morphant ещё обсуждается.
...
`|`, `;`, пробел как разделитель, пустые элементы/строка и qualified names — нет.
Отдельные `0`, `3`, неназванное `8` принимаются; `0x3`, `1,2`, `Read,2` — нет.
...
Применимость режима к string-парам, единица Members, разделители, пустые элементы,
числовой текст и обратное форматирование остаются вопросами для обсуждения.
Новый контракт строкового mapping в этом исследовании не устанавливается.
