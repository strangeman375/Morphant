...
Статус на 2026-09-08: аудит завершён, S05-02 исправлен. Первое исправление
S05-01 на `ba151fb` пересмотрено: реализовано
[единое значение параметра конструктора и члена](RELEASE_REVIEW_STAGE_05_MEMBER_VALUES.md).
Проверка достижимых веток для значения, зависящего от `result`, реализована
и проверена локально. Публикация контрольных точек заблокирована автоматической
проверкой согласования. Результаты предыдущего поведения — в
...
Рекомендация исходного аудита: согласовать и исправить S05-01 и S05-02 перед этапом 6,
...
категорий и этих воспроизведений. На момент исходного аудита исправления
не были выполнены; актуальный статус приведён в начале отчёта.
