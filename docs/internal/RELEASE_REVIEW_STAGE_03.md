...
Статус: исходная проверка этапа завершена. Найденные S03-01–S03-03 впоследствии исправлены по согласованному решению и закрыты в проверенной области; [итог исправлений](RELEASE_REVIEW_STAGE_03_FIXES.md). Этап 4 не начат. Пользователь отдельно разрешил публикацию отчёта и воспроизведений в публичный `main`.

После отчёта пользователь отдельно запросил анализ и выбор исправлений. Обоснование сохранено в [решениях S03-01–S03-03](RELEASE_REVIEW_STAGE_03_SOLUTIONS.md). Ниже сохранены исторические наблюдения на исходной версии; их отказы и числа тестов не описывают исправленную реализацию.
