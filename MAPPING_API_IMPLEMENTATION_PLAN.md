...
**Фаза 6, этап 23 — diagnostics, этап 1: таксономия.**
...
[`DIAGNOSTICS_PLAN.md`](DIAGNOSTICS_PLAN.md); его первый этап фиксирует 12
категорий и общие границы, не детализируя отдельные diagnostics.
...
Статус: не начат; подготовительный этап 1 ожидает ревью.
